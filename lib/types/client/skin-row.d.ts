...
export type SkinRowComponentProps = PropsRuntime<'settings.appearance.item'> & PropsStore<ReturnType<typeof createSkinRowStore>> & PropsLocale<'settings.skin-manager'> & SkinRowInjected;
/**
 * Render the skin row.
