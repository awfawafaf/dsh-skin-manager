window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		/** Skin-manager settings row dictionaries. */
		const zh = { title: "皮肤" };
		const en = { title: "Skin" };
		//#endregion
		...
		*/
		function apply(ctx) {
			const runtime = new SkinManagerRuntime(ctx, ctx.settingsScope.bind({ namespace: SKIN_SETTINGS_NAMESPACE }));
