window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#region \0dsh-css:src/client/skin-row.module.css.mjs
		const css$1 = ".PYvRQG_group{border-bottom:1px solid var(--dsw-alias-border-l2);flex-direction:column;gap:8px;padding:16px 0;display:flex}.PYvRQG_title{color:var(--dsw-alias-label-primary);font-size:14px;font-weight:400;line-height:22px}.PYvRQG_chipRow{flex-wrap:wrap;align-items:center;gap:8px;display:flex}.PYvRQG_chip{border:1px solid var(--dsw-alias-border-l2);font:inherit;color:var(--dsw-alias-label-primary);cursor:pointer;background:0 0;border-radius:999px;align-items:center;gap:6px;padding:7px 14px;font-size:14px;line-height:22px;display:inline-flex}.PYvRQG_chip:hover:not(.PYvRQG_selected){background:var(--dsw-alias-interactive-bg-hover)}.PYvRQG_selected{background:var(--dsw-alias-bg-module-platform);border-color:var(--dsw-static-neutral-bluish-400);color:var(--dsw-alias-label-primary)}.PYvRQG_swatch{border-radius:50%;width:10px;height:10px}";
		const tagId$1 = "dsh-skin-manager/skin-row.module.css";
		if (typeof document !== "undefined" && document.querySelector("style[data-plugin-css=" + JSON.stringify(tagId$1) + "]") === null) {
			const tag = document.createElement("style");
			tag.dataset.plugin = "dsh-skin-manager";
			tag.dataset.pluginCss = tagId$1;
			tag.textContent = css$1;
			document.head.appendChild(tag);
		}
		var skin_row_module_css_default = {
			"chip": "PYvRQG_chip",
			"chipRow": "PYvRQG_chipRow",
			"group": "PYvRQG_group",
			"selected": "PYvRQG_selected",
			"swatch": "PYvRQG_swatch",
			"title": "PYvRQG_title"
		};
		//#endregion
		//#region src/client/skin-row.tsx
		/**
		* Render the skin row.
		...
		*/
		function SkinRow({ t, setSkin, useStore }) {
			...
			const ordered = [...useStore((s) => s.skins)].sort((left, right) => (left.order ?? 0) - (right.order ?? 0));
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				className: skin_row_module_css_default.group,
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
					className: skin_row_module_css_default.title,
					children: t("title")
				}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
					className: skin_row_module_css_default.chipRow,
					children: ordered.map((skin) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("button", {
						type: "button",
						className: activeId === skin.id ? `${skin_row_module_css_default.chip} ${skin_row_module_css_default.selected}` : skin_row_module_css_default.chip,
						"aria-pressed": activeId === skin.id,
						onClick: () => {
							setSkin(skin.id);
						},
						children: [skin.accent !== void 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
							className: skin_row_module_css_default.swatch,
		...
		//#endregion
		//#region \0dsh-css:src/client/appearance-section.module.css.mjs
		const css = ".dMq-5a_section{flex-direction:column;width:100%;display:flex}.dMq-5a_section>[data-slot=\"settings.appearance.item\"]>:last-child{border-bottom:none}";
		const tagId = "dsh-skin-manager/appearance-section.module.css";
		...
		var appearance_section_module_css_default = { "section": "dMq-5a_section" };
		//#endregion
		//#region src/client/appearance-section.tsx
		/**
		* Render the Appearance section content column.
		* @param props - composed slot props (contract/slots.ts).
		* @returns the section element tree.
		*/
		function AppearanceSection({ renderSlot }) {
			return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
				className: appearance_section_module_css_default.section,
		...
		*/
		function createFetchScope(route) {
			let value;
			...
			return {
				getSnapshot: () => ({
					status: value === void 0 ? "loading" : "ready",
					value,
					base: void 0,
					user: void 0,
					revision: void 0,
		...
		Schema.object({ [SKIN_SETTINGS_FIELD]: Schema.string().default(DEFAULT_SKIN) });
		//#endregion
		//#region src/client/skin-manager.ts
		/** The built-in skin representing the DSH stock look. */
		const CLASSIC_SKIN = Object.freeze({
			id: "classic",
			label: "经典",
			labelEn: "Classic",
			apply: () => () => {}
		...
		* skin reinstalls).
		*/
		var SkinManagerRuntime = class {
			ctx;
			host;
			definitions = /* @__PURE__ */ new Map();
			preferred = DEFAULT_SKIN;
			...
			*/
			constructor(ctx, host) {
				...
				ctx.effect(() => host.subscribe(() => {
					this.adopt();
				}), "dsh-skin-manager: settings scope adoption");
				this.adopt();
			}
			/**
			...
			*/
			setSkin(id) {
				if (!this.definitions.has(id)) throw new Error(`skin "${id}" is not registered`);
				if (this.preferred === id && this.active === id) return;
				this.preferred = id;
				this.host.set(SKIN_SETTINGS_FIELD, id);
				this.apply(id);
				this.publish();
			}
			/**
			...
			*/
			register(skin) {
				if (skin.id === "classic") throw new Error(`"${DEFAULT_SKIN}" is the built-in default skin id`);
				if (this.definitions.has(skin.id)) throw new Error(`skin "${skin.id}" is already registered`);
			...
			*/
			...
			adopt() {
				...
				if (section === void 0 || section.skin === this.preferred) return;
		...
		function toView(skin) {
			return {
				id: skin.id,
				label: skin.label,
				...skin.labelEn !== void 0 ? { labelEn: skin.labelEn } : {},
				...skin.accent !== void 0 ? { accent: skin.accent } : {},
				...skin.order !== void 0 ? { order: skin.order } : {}
			};
		}
		//#endregion
		//#region src/client/index.ts
		/** Namespace owning this feature's settings-row copy. */
		const SETTINGS_NS = "settings.skin-manager";
		...
		*/
		function apply(ctx) {
			const runtime = new SkinManagerRuntime(ctx, createFetchScope("/skin-manager/settings"));
			ctx.provide("skinManager", runtime);
			ctx.effect(() => () => runtime.dispose(), "dsh-skin-manager: active skin teardown");
			ctx.effect(() => ctx.locale.register(SETTINGS_NS, {
				zh,
				en
			}), "dsh-skin-manager: settings row dictionaries");
		...
		//#endregion
		exports.CLASSIC_SKIN = CLASSIC_SKIN;
		exports.SETTINGS_NS = SETTINGS_NS;
		exports.SkinManagerRuntime = SkinManagerRuntime;
		exports.apply = apply;
